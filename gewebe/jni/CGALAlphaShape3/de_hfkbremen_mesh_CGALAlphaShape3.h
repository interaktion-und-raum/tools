...
#include <jni.h>
/* Header for class de_hfkbremen_mesh_CGALAlphaShape3 */

#ifndef _Included_de_hfkbremen_mesh_CGALAlphaShape3
#define _Included_de_hfkbremen_mesh_CGALAlphaShape3
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     de_hfkbremen_mesh_CGALAlphaShape3
 * Method:    version
 * Signature: ()I
 */
