...
public abstract class SynthesizerManager {
    ...
    public static SynthesizerManager createSynth() {
        return new SynthesizerJSyn(INSTRUMENT_WITH_OSCILLATOR_ADSR);
    }

    public static SynthesizerManager createSynth(String... pName) {
        if (pName.length > 0) {
    ...
    public static ControlP5 createInstrumentsGUI(PApplet p, SynthesizerManager mSynth) {
        return createInstrumentsGUI(p, mSynth, NUMBERS_OF_INSTRUMENTS);
    }

    public static ControlP5 createInstrumentsGUI(PApplet p, SynthesizerManager mSynth, int... mInstruments) {
